...
const String ssid = "MiFibra-9B77";
const String password = "oRfwyF6X";
const char *duckDnsToken = "b5a71b4f-9685-4559-8b14-96a63bdc5be3";
const char *duckDnsDomain = "infindgrupo10cam.duckdns.org";
...
//-----------------------------------------------------------
void updateDuckDNS() {
  Serial.print("Enviando dirección IP a DuckDNS...");
  String duckdnsUpdateURL = "http://" + String(duckDnsToken) + ".duckdns.org/update?domains=" + duckDnsDomain;
  HTTPClient http;
  http.begin(duckdnsUpdateURL);
  int httpResponseCode = http.GET();

  if (httpResponseCode > 0) {
    Serial.println(" Actualización exitosa");
  } else {
    Serial.print(" Error en la actualización. Código de respuesta: ");
